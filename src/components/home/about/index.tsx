    ...
    <section className={style["about"]}>
      <div className={`${style["about__container"]} ${'container'}`}>
        ...
        <div className={style["about__info-box"]}>
          ...
          <p className={style["about__info-text"]}>
            Мы предоставляем учителям английского языка полный набор ресурсов для создания увлекательных и эффективных уроков. Наша цель заключается в том, чтобы облегчить труд учителя, сэкономить его время, вдохновить на создание креативных и результативных уроков. 
          </p>
          <Link to={'/about'}>
